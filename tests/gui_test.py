...
def main():
    ...
    gui_module.check_for_updates = lambda _version: {
        ...
        "release_url": "https://github.com/XiaoLan9999/maimai-vrchat-osc/releases/tag/v2.1.14",
    }
    ...
    try:
        ...
        assert app.status_vars["update"].get() == "当前 2.1.14 已是最新版"
        app.close()
    finally:
